                  ...
                  <div class="box-body">
                    <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="mail_in_id" placeholder="Masukan Id Surat">
                          </div>
                          <div class="form-group">
                            <label>Tanggal Datang</label>
                            <input name="incoming_at" type="date" class="form-control">                  
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mail_from" placeholder="Masukan Surat Dari">
                          </div>
                        </div> 
                    <div class="col-md-6">
                        <div class="form-group">
...
function validasi_input(form){
   if (form.incoming_at.value == ""){
    alert("Maaf Field Tidak boleh ada yang kosong!");
    form.incoming_at.focus();
    return (false);
...
if(isset($submit)){
    ...
    if ($mail_type_id =="" ) {
     ?>
        ...
        $sql="INSERT INTO `mail_in` (`mail_in_id`, `incoming_at`, `mail_code`, `mail_date`, `mail_from`, `mail_to`, `mail_subject`, `description`, `file_upload`, `mail_type_id`, `user_id`) VALUES ('$mail_in_id', '$incoming_at', '$mail_code', '$mail_date', '$mail_from', '$mail_to', '$mail_subject', '$description', '$gambar', '$mail_type_id', '$user');";
        ...
        <script type="text/javascript">
            ...
            window.location='./index.php?page=mail_in';
        </script><?php
    }else{
        echo "error";
    }
