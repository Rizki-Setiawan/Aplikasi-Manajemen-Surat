...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Aplikasi</b>&nbspSurat</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-tasks "></i> <span>Master Data</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="index.php?page=mail_type"><i class="fa fa-circle-o text-green"></i>Tipe Surat</a></li>
                <li class="treeview">
                  <a href="#">
                    <i class="fa fa-circle-o text-red"></i> <span>Surat</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="index.php?page=mail_in"><i class="fa fa-circle-o text-aqua"></i>Surat Masuk</a></li>
                    
                    <li><a href="index.php?page=mail_out"><i class="fa fa-circle-o text-aqua"></i>Surat Keluar</a></li>
                  </ul>
                </li>
            <li><a href="index.php?page=disposition"><i class="fa fa-circle-o text-yellow"></i> Disposisi</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <font style="color : #72AFD2;">Rizki Setiawan</font>.</strong> All rights
    reserved.
  </footer>
